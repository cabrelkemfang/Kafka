...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, MessageRequest> userConsumerFactory() {
        ...
        props.put(JsonDeserializer.TRUSTED_PACKAGES, "io.growtogether.com.kafkaProducer.dto");
    ...
    @Bean
    public KafkaListenerContainerFactory<ConcurrentMessageListenerContainer<String, MessageRequest>> userFactory(
            ConsumerFactory<String, MessageRequest> userConsumerFactory
    ) {
